          ...
          <Container className="bg-white rounded-xl p-8 mx-auto max-w-[600px]">
            <Section>
              ...
              <Text className="text-[16px] text-gray-700 mb-6 mt-0 leading-6">
                We received a request to delete your account. If you didn't make this request, you
                can safely ignore this email and your account will remain active.
              </Text>
              ...
              <Text className="text-[14px] text-blue-600 mb-8 mt-0 break-all">{deleteUrl}</Text>
            </Section>
          </Container>
        </Body>
      </Tailwind>
