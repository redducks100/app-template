...
function AuthLayout() {
  return (
    <div className="flex min-h-svh w-full">
      {/* Left brand panel */}
      <div className="hidden md:flex md:w-[420px] lg:w-[480px] shrink-0 flex-col justify-between bg-foreground p-10 text-background relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold tracking-tight">Enomisoft</span>
          </div>
        </div>
        ...
        <div className="relative z-10 text-xs text-background/40">
          &copy; {new Date().getFullYear()} Enomisoft
        </div>
      </div>
